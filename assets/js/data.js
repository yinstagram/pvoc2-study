...
export const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": "C",
    "explanation_tc": "⚠ 重要：答案 C（CH 67）只適用於圖示嘅 Western Approaches sector。CH 67 係西進口航道區段嘅 VHF 頻道，唔係全港通用 incident reporting channel。香港 VTC 5 個 sector：CH 02 (Harbour East)、CH 12 (Eastern Approaches)、CH 14 (Harbour)、CH 63 (Lantau South)、CH 67 (Western Approaches)。CH 16 係國際遇險頻道。考試睇圖區分。",
    "image_required": true,
    "image_status": "available",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation_tc": "⚠ EN 同 TC 兩版題幹有差異！TC 版考夜晚甚快閃白光（每分鐘約 100 閃，VQ rhythm）= isolated danger 或 cardinal mark。275° 西行，圖示浮標 → 向右轉令浮標在左舷通過。EN 版考 070°(T) 浮標方位識別。考試會出現呢類兩版稍有出入嘅情況；以官方答案 B 為準。",
    "image_required": false,
    "image_status": "not_required",
    "image_asset_path": null,
    "image_webp_asset_path": null,
